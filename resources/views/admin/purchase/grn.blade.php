...
@section('title', 'GRN')
@section('page-title', 'Goods Received Note (GRN)')
@section('page-description', 'Manage goods received notes and stock entries')

@section('content')
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h3 class="text-lg font-semibold text-gray-900">Goods Received Notes</h3>
            <p class="text-sm text-gray-500 mt-1">Record and manage stock receipts</p>
        </div>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">GRN-2024-001</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">PO-2024-002</td>
