...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <div>
            ...
            <small class="text-muted">Update system user details</small>
        </div>
                    ...
                    <div class="card-body p-8">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8 pl-1">
                                <input type="text" name="name" class="form-control form-control-sm" value="{{ old('name', $user->name) }}" placeholder="Full name" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8 pl-1">
                                <input type="email" name="email" class="form-control form-control-sm" value="{{ old('email', $user->email) }}" placeholder="Email address" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8 pl-1">
                                <input type="text" name="mobile_number" class="form-control form-control-sm" value="{{ old('mobile_number', $user->mobile_number) }}" placeholder="Mobile number">
                            </div>
                        </div>
