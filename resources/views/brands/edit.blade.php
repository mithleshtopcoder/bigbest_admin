        ...
        <div class="col-12">
            <div class="card stretch stretch-full">
                <div class="card-body">
                    ...
                    <form action="{{ route('manage-product.brands.update', $brand->id) }}" method="POST" enctype="multipart/form-data" id="brandForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="name" class="form-control form-control-sm" value="{{ old('name', $brand->name) }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="url" name="website" class="form-control form-control-sm" value="{{ old('website', $brand->website) }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <textarea name="description" id="descriptionEditor" class="form-control form-control-sm" rows="4">{{ old('description', $brand->description) }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <div class="mt-2">
                                            <img id="imagePreview" src="{{ $brand->image ? asset($brand->image) : '' }}" class="img-thumbnail" style="width:120px;height:120px;object-fit:cover; {{ $brand->image ? '' : 'display:none;' }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <div class="mt-2">
                                            <img id="logoPreview" src="{{ $brand->logo ? asset($brand->logo) : '' }}" class="img-thumbnail" style="width:120px;height:120px;object-fit:contain; {{ $brand->logo ? '' : 'display:none;' }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="number" name="sort_order" class="form-control form-control-sm" value="{{ old('sort_order', $brand->sort_order) }}">
                                    </div>
                                </div>
