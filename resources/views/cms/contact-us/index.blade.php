                    ...
                    <form action="#" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="alternate_phone" name="alternate_phone" value="+91 98765 43211">
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="latitude" name="latitude" value="19.0760">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="longitude" class="form-label">Longitude</label>
                                <input type="text" class="form-control" id="longitude" name="longitude" value="72.8777">
                            </div>
                            <div class="col-12 mb-3">
