        ...
        <div class="page-header-right-items">
            ...
            <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                <a href="javascript:void(0);" class="btn btn-primary btn-sm">
                    <i class="feather-plus me-2"></i>Add Payment Method
                </a>
            </div>
        </div>
                        ...
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><span class="badge bg-soft-primary text-primary">Offline</span></td>
                                    <td>-</td>
                                    <td>0.00%</td>
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge bg-soft-info text-info">Online</span></td>
                                    <td>Razorpay</td>
                                    <td>2.00%</td>
                                    <td><span class="badge bg-soft-success text-success">Active</span></td>
                                    <td class="text-end">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center gap-3">
                                            ...
                                            <a href="javascript:void(0);">
                                                <span class="d-block">Net Banking</span>
                                            </a>
                                        </div>
                                    </td>
                                    <td><span class="badge bg-soft-info text-info">Online</span></td>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center gap-3">
                                            ...
                                            <a href="javascript:void(0);">
                                                <span class="d-block">Cheque</span>
                                            </a>
                                        </div>
                                    </td>
                                    <td><span class="badge bg-soft-primary text-primary">Offline</span></td>
