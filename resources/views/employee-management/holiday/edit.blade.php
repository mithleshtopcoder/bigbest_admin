...
<div class="page-header">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
        <div class="page-header-left d-flex" style="align-items: baseline;">
            <h1 class="page-title mb-0">Edit Holiday</h1>
...
<div class="">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('employee-management.holiday.update', $holiday->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="title" class="form-control" placeholder="Enter holiday title" value="{{ old('title', $holiday->title) }}" required>
                                @error('title')
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-8">
                                <input type="date" name="holiday_date" class="form-control" value="{{ old('holiday_date', $holiday->holiday_date ? \Carbon\Carbon::parse($holiday->holiday_date)->format('Y-m-d') : '') }}" required>
                                @error('holiday_date')
                                    <div class="text-danger small">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-8">
                                <textarea name="description" class="form-control" rows="4" placeholder="Enter holiday description">{{ old('description', $holiday->description) }}</textarea>
                                @error('description')
                                    <div class="text-danger small">{{ $message }}</div>
                                @enderror
                            </div>
