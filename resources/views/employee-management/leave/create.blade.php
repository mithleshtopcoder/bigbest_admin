...
<div class="page-header">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
        <div class="page-header-left d-flex" style="align-items: baseline;">
            <h1 class="page-title mb-0">Create Leave</h1>
...
<div class="">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('employee-management.leave.store') }}" method="POST">
                @csrf
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="leave_type" class="form-control" placeholder="e.g., Casual, Sick, Annual" value="{{ old('leave_type') }}">
                                @error('leave_type')
                                    <div class="text-danger small">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-8">
                                <textarea name="reason" class="form-control" rows="4" placeholder="Enter reason for leave">{{ old('reason') }}</textarea>
                                @error('reason')
                                    <div class="text-danger small">{{ $message }}</div>
                                @enderror
                            </div>
                ...
                <div class="row">
                    <div class="col-md-12 text-end">
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-save me-2"></i>Save Leave
                        </button>
                    </div>
                </div>
            </form>
