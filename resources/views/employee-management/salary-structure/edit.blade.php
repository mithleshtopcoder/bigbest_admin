...
@section('title', 'Edit Salary Structure - ' . $employee->user->name)

@section('content')
<div class="page-header">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
        <div class="page-header-left d-flex" style="align-items: baseline;">
            <h1 class="page-title mb-0">Edit Salary Structure</h1>
...
<div class="">
    <div class="card">
        <div class="card-header">
            <h5 class="card-title mb-0">Edit Salary Structure for {{ $employee->user->name }}</h5>
        </div>
        <div class="card-body">
            <form action="{{ route('employee-management.salary-structure.update', [$employee->user->uuid, $salaryStructure->id]) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <input type="number" name="basic_salary" class="form-control" placeholder="Enter basic salary" step="0.01" required value="{{ old('basic_salary', $salaryStructure->basic_salary) }}">
                                @error('basic_salary')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <input type="number" name="hra" class="form-control" placeholder="Enter HRA" step="0.01" value="{{ old('hra', $salaryStructure->hra) }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-5 form-label">DA (Dearness Allowance)</label>
                            <div class="col-md-7">
                                <input type="number" name="da" class="form-control" placeholder="Enter DA" step="0.01" value="{{ old('da', $salaryStructure->da) }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-5 form-label">TA (Travel Allowance)</label>
                            <div class="col-md-7">
                                <input type="number" name="ta" class="form-control" placeholder="Enter TA" step="0.01" value="{{ old('ta', $salaryStructure->ta) }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-5 form-label">Medical Allowance</label>
                            <div class="col-md-7">
                                <input type="number" name="medical_allowance" class="form-control" placeholder="Enter medical allowance" step="0.01" value="{{ old('medical_allowance', $salaryStructure->medical_allowance) }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-5 form-label">Other Allowances</label>
                            <div class="col-md-7">
                                <input type="number" name="other_allowances" class="form-control" placeholder="Enter other allowances" step="0.01" value="{{ old('other_allowances', $salaryStructure->other_allowances) }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <input type="number" name="pf" class="form-control" placeholder="Enter PF deduction" step="0.01" value="{{ old('pf', $salaryStructure->pf) }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-5 form-label">ESI (Emp State Insurance)</label>
                            <div class="col-md-7">
                                <input type="number" name="esi" class="form-control" placeholder="Enter ESI deduction" step="0.01" value="{{ old('esi', $salaryStructure->esi) }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-5 form-label">TDS (Tax Deducted at Source)</label>
                            <div class="col-md-7">
                                <input type="number" name="tds" class="form-control" placeholder="Enter TDS" step="0.01" value="{{ old('tds', $salaryStructure->tds) }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-5 form-label">Other Deductions</label>
                            <div class="col-md-7">
                                <input type="number" name="other_deductions" class="form-control" placeholder="Enter other deductions" step="0.01" value="{{ old('other_deductions', $salaryStructure->other_deductions) }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-5 form-label">Gross Salary</label>
                            <div class="col-md-7">
                                <input type="number" id="gross_salary" class="form-control" placeholder="Auto-calculated" step="0.01" readonly value="{{ $salaryStructure->gross_salary }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-5 form-label">Net Salary</label>
                            <div class="col-md-7">
                                <input type="number" id="net_salary" class="form-control" placeholder="Auto-calculated" step="0.01" readonly value="{{ $salaryStructure->net_salary }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-5 form-label">Effective Date</label>
                            <div class="col-md-7">
                                <input type="date" name="effective_date" class="form-control" value="{{ old('effective_date', $salaryStructure->effective_date ? \Carbon\Carbon::parse($salaryStructure->effective_date)->format('Y-m-d') : '') }}">
                            </div>
                        </div>
                        <input type="hidden" name="currency" value="{{ old('currency', $salaryStructure->currency ?? 'INR') }}">
                        <div class="form-group row">
                            <label class="col-md-5 form-label">Status</label>
                            <div class="col-md-7">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="status" id="status" value="1" {{ old('status', $salaryStructure->status) ? 'checked' : '' }}>
                    ...
                    <div class="col-12">
                        <div class="d-flex justify-content-end gap-2">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-save me-2"></i>Update Salary Structure
                            </button>
                        </div>
                    </div>
                </div>
