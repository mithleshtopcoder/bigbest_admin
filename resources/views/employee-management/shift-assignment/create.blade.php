...
<div class="page-header">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
        <div class="page-header-left d-flex" style="align-items: baseline;">
            <h1 class="page-title mb-0">Assign Shift</h1>
...
<div class="">
    <div class="card">
        <div class="card-header">
            <h5 class="card-title mb-0">Assign Shift to Employee</h5>
        </div>
        <div class="card-body">
            <form action="{{ route('employee-management.shift-assignment.store') }}" method="POST">
                @csrf
                ...
                <div class="row">
                    <div class="col-md-6">
                            ...
                            <div class="col-md-8">
                                <select class="form-select" name="shift_id" id="shiftSelect" required>
                                    ...
                                    @foreach($shifts as $shift)
                                        <option value="{{ $shift->id }}" data-start="{{ \Carbon\Carbon::createFromFormat('H:i:s', $shift->start_time)->format('H:i') }}" data-end="{{ \Carbon\Carbon::createFromFormat('H:i:s', $shift->end_time)->format('H:i') }}" {{ old('shift_id') == $shift->id ? 'selected' : '' }}>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-8">
                                <input type="date" name="effective_from" class="form-control" value="{{ old('effective_from', date('Y-m-d')) }}" required>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-8">
                                <input type="date" name="effective_to" class="form-control" value="{{ old('effective_to') }}" placeholder="Leave empty for ongoing">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-8">
                                <textarea name="remarks" class="form-control" rows="4" placeholder="Enter any remarks">{{ old('remarks') }}</textarea>
                                @error('remarks')
                                    <div class="text-danger small">{{ $message }}</div>
                                @enderror
                            </div>
                ...
                <div class="row">
                    <div class="col-md-12 text-end">
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-save me-2"></i>Assign Shift
                        </button>
                    </div>
                </div>
            </form>
