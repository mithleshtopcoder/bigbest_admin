...
<div class="page-header">
    <div class="page-header-left d-flex align-items-center">
        <div class="page-header-title">
            <h5 class="m-b-10">Store Ledger</h5>
        </div>
        <ul class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Home</a></li>
            <li class="breadcrumb-item">Finance & Accounting</li>
            <li class="breadcrumb-item">Store Ledger</li>
        </ul>
    </div>
...
<div class="main-body">
    <div class="row">
        <!-- [Store Ledger List] start -->
        <div class="col-12">
            <div class="card stretch stretch-full">
                <div class="card-header">
                    <h5 class="card-title">Store Ledger</h5>
                        ...
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><span class="fw-bold text-success">₹2,45,600</span></td>
                                ...
                                <tr>
                                    ...
                                    <td><span class="fw-bold text-muted">-</span></td>
                                    <td><span class="fw-bold text-dark">₹2,30,600</span></td>
                                    <td class="text-end">
                                        <div class="d-flex align-items-center gap-2 justify-content-end">
                                            <div class="dropdown">
                                                <a href="javascript:void(0);" class="avatar-text avatar-sm" data-bs-toggle="dropdown" data-bs-offset="25, 25" title="Actions">
                                ...
                                <tr>
                                    ...
                                    <td><span class="fw-bold text-dark">₹4,16,000</span></td>
                                    <td class="text-end">
                                        <div class="d-flex align-items-center gap-2 justify-content-end">
                                            <div class="dropdown">
                                                <a href="javascript:void(0);" class="avatar-text avatar-sm" data-bs-toggle="dropdown" data-bs-offset="25, 25" title="Actions">
                                ...
                                <tr>
                                    ...
                                    <td><span class="fw-bold text-danger">₹50,000</span></td>
                                    <td><span class="fw-bold text-muted">-</span></td>
                                    <td><span class="fw-bold text-dark">₹3,66,000</span></td>
                                    <td class="text-end">
                                        <div class="d-flex align-items-center gap-2 justify-content-end">
                                            <div class="dropdown">
                                                <a href="javascript:void(0);" class="avatar-text avatar-sm" data-bs-toggle="dropdown" data-bs-offset="25, 25" title="Actions">
                                ...
                                <tr>
                                    ...
                                    <td>Sales Revenue</td>
                                    <td><span class="fw-bold text-muted">-</span></td>
                                    <td><span class="fw-bold text-success">₹3,12,800</span></td>
                                    <td><span class="fw-bold text-dark">₹4,16,000</span></td>
                                    <td class="text-end">
                                        <div class="d-flex align-items-center gap-2 justify-content-end">
                                            <div class="dropdown">
                                ...
                                <tr>
                                    ...
                                    <td><span class="fw-bold text-danger">₹2,00,000</span></td>
                                    <td><span class="fw-bold text-muted">-</span></td>
                                    <td><span class="fw-bold text-dark">₹1,03,200</span></td>
                                    <td class="text-end">
                                        <div class="d-flex align-items-center gap-2 justify-content-end">
                                            <div class="dropdown">
                                                <a href="javascript:void(0);" class="avatar-text avatar-sm" data-bs-toggle="dropdown" data-bs-offset="25, 25" title="Actions">
                                ...
                                <tr>
                                    ...
                                    <td><span class="fw-bold text-dark">₹3,03,200</span></td>
                                    <td class="text-end">
                                        <div class="d-flex align-items-center gap-2 justify-content-end">
                                            <div class="dropdown">
                                                <a href="javascript:void(0);" class="avatar-text avatar-sm" data-bs-toggle="dropdown" data-bs-offset="25, 25" title="Actions">
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge bg-soft-danger text-danger">Debit</span></td>
                                    <td>Rent Payment</td>
                                    <td><span class="fw-bold text-danger">₹25,000</span></td>
                                    <td><span class="fw-bold text-muted">-</span></td>
                                    <td><span class="fw-bold text-dark">₹1,78,700</span></td>
                                    <td class="text-end">
                                        <div class="d-flex align-items-center gap-2 justify-content-end">
                                            <div class="dropdown">
                                                <a href="javascript:void(0);" class="avatar-text avatar-sm" data-bs-toggle="dropdown" data-bs-offset="25, 25" title="Actions">
