                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        <div class="dropdown-item">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" id="SupplierFilter" checked="checked" />
                                <label class="custom-control-label c-pointer" for="SupplierFilter">Supplier</label>
                            </div>
                        </div>
                        <div class="dropdown-item">
                            <div class="custom-control custom-checkbox">
                        ...
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>Gold Suppliers Ltd</td>
                                    <td><span class="badge bg-soft-danger text-danger">Debit</span></td>
                                    <td>Purchase Payment</td>
                                    <td><span class="fw-bold text-danger">₹2,45,600</span></td>
                                    <td><span class="fw-bold text-muted">-</span></td>
                                    <td><span class="fw-bold text-dark">₹2,45,600</span></td>
                                    <td class="text-end">
                                ...
                                <tr>
                                    ...
                                    <td>Silver Traders Inc</td>
                                    <td><span class="badge bg-soft-success text-success">Credit</span></td>
                                    <td>Purchase Invoice</td>
                                    <td><span class="fw-bold text-muted">-</span></td>
                                    <td><span class="fw-bold text-success">₹1,85,400</span></td>
                                    <td><span class="fw-bold text-dark">₹60,200</span></td>
                                    <td class="text-end">
                                        <div class="d-flex align-items-center gap-2 justify-content-end">
                                            <div class="dropdown">
                                                <a href="javascript:void(0);" class="avatar-text avatar-sm" data-bs-toggle="dropdown" data-bs-offset="25, 25" title="Actions">
                                ...
                                <tr>
                                    ...
                                    <td>Diamond Merchants</td>
                                    <td><span class="badge bg-soft-danger text-danger">Debit</span></td>
                                    <td>Purchase Payment</td>
                                    <td><span class="fw-bold text-danger">₹3,12,800</span></td>
                                    <td><span class="fw-bold text-muted">-</span></td>
                                    <td><span class="fw-bold text-dark">₹3,73,000</span></td>
                                    <td class="text-end">
                                        <div class="d-flex align-items-center gap-2 justify-content-end">
                                            <div class="dropdown">
                                                <a href="javascript:void(0);" class="avatar-text avatar-sm" data-bs-toggle="dropdown" data-bs-offset="25, 25" title="Actions">
                                ...
                                <tr>
                                    ...
                                    <td>Platinum Distributors</td>
                                    <td><span class="badge bg-soft-success text-success">Credit</span></td>
                                    <td>Purchase Invoice</td>
                                    <td><span class="fw-bold text-muted">-</span></td>
                                    <td><span class="fw-bold text-success">₹1,24,500</span></td>
                                    <td><span class="fw-bold text-dark">₹60,200</span></td>
                                    <td class="text-end">
                                        <div class="d-flex align-items-center gap-2 justify-content-end">
                                            <div class="dropdown">
                                ...
                                <tr>
                                    ...
                                    <td>Jewelry Wholesalers</td>
                                    <td><span class="badge bg-soft-danger text-danger">Debit</span></td>
                                    <td>Purchase Payment</td>
                                    <td><span class="fw-bold text-danger">₹4,56,200</span></td>
                                    <td><span class="fw-bold text-muted">-</span></td>
                                    <td><span class="fw-bold text-dark">₹4,16,400</span></td>
                                    <td class="text-end">
                                        <div class="d-flex align-items-center gap-2 justify-content-end">
                                            <div class="dropdown">
                                                <a href="javascript:void(0);" class="avatar-text avatar-sm" data-bs-toggle="dropdown" data-bs-offset="25, 25" title="Actions">
                                ...
                                <tr>
                                    ...
                                    <td>Gemstone Importers</td>
                                    <td><span class="badge bg-soft-success text-success">Credit</span></td>
                                    <td>Purchase Invoice</td>
                                    <td><span class="fw-bold text-muted">-</span></td>
                                    <td><span class="fw-bold text-success">₹1,67,300</span></td>
                                    <td><span class="fw-bold text-dark">₹-2,39,800</span></td>
                                    <td class="text-end">
                                        <div class="d-flex align-items-center gap-2 justify-content-end">
                                            <div class="dropdown">
                                                <a href="javascript:void(0);" class="avatar-text avatar-sm" data-bs-toggle="dropdown" data-bs-offset="25, 25" title="Actions">
                                ...
                                <tr>
                                    ...
                                    <td>Precious Metals Co</td>
                                    <td><span class="badge bg-soft-danger text-danger">Debit</span></td>
                                    <td>Purchase Payment</td>
                                    <td><span class="fw-bold text-danger">₹2,89,500</span></td>
                                    <td><span class="fw-bold text-muted">-</span></td>
                                    <td><span class="fw-bold text-dark">₹-4,07,100</span></td>
                                    <td class="text-end">
                                        <div class="d-flex align-items-center gap-2 justify-content-end">
                                            <div class="dropdown">
                                                <a href="javascript:void(0);" class="avatar-text avatar-sm" data-bs-toggle="dropdown" data-bs-offset="25, 25" title="Actions">
                                ...
                                <tr>
                                    ...
                                    <td>Ornament Exporters</td>
                                    <td><span class="badge bg-soft-success text-success">Credit</span></td>
                                    <td>Purchase Invoice</td>
                                    <td><span class="fw-bold text-muted">-</span></td>
                                    <td><span class="fw-bold text-success">₹1,45,800</span></td>
                                    <td><span class="fw-bold text-dark">₹-2,61,300</span></td>
                                    <td class="text-end">
                                        <div class="d-flex align-items-center gap-2 justify-content-end">
                                            <div class="dropdown">
                                                <a href="javascript:void(0);" class="avatar-text avatar-sm" data-bs-toggle="dropdown" data-bs-offset="25, 25" title="Actions">
