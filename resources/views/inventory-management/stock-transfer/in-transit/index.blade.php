...
<div class="page-header d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
    <div class="page-header-left d-flex align-items-baseline">
        <h1 class="page-title mb-0">In-Transit Stock</h1>
        <nav aria-label="breadcrumb" class="px-2">
            <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                <li class="breadcrumb-item active">In-Transit Stock</li>
            </ol>
        </nav>
    </div>
</div>
...
<div class="main-body">
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center py-2">
            <h5 class="card-title mb-0">In-Transit Transfers</h5>
        ...
        <div class="card-body p-2">
            ...
            <div class="table-responsive">
                <table id="inTransitTable" class="table table-hover table-bordered align-middle">
...
<script>
    $(document).ready(function() {
        let table = $('#inTransitTable').DataTable({
            processing: true
            , serverSide: true
            , ajax: {
                url: '{{ route("inventory-management.stock-transfer.in-transit") }}'
                , data: function(d) {
            ...
            , columns: [{
                ...
                , {
                    ...
                    , render: function(data, row) {
                        let viewUrl = `/inventory-management/stock-transfer/in-transit/${row.id}`;
                        let markDeliveredBtn = `<button class="btn btn-sm btn-success" onclick="markDelivered(${row.id})" title="Mark Delivered"><i class="bi bi-check-circle-fill"></i></button>`;
    ...
    function markDelivered(id) {
        if (confirm('Mark this transfer as delivered?')) {
            $.post(`/inventory-management/stock-transfer/in-transit/${id}/delivered`, {
