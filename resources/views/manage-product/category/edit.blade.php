        ...
        <div class="col-12">
            <div class="card stretch stretch-full">
                <div class="card-body">
                    ...
                    <form action="{{ route('manage-product.category.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 pl-1">
                                        <textarea name="description" class="form-control form-control-sm" rows="4">{{ old('description', $category->description) }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 pl-1">
                                        <input type="text" name="label" class="form-control form-control-sm" value="{{ old('label', $category->label) }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 pl-1">
                                        <input type="number" name="sort_order" class="form-control form-control-sm" value="{{ old('sort_order', $category->sort_order) }}">
                                    </div>
                                </div>
