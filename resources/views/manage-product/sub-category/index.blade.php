...
<div class="page-header">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
        <div class="page-header-left d-flex align-items-baseline">
            <h1 class="page-title mb-0">Sub Category Master</h1>
        ...
        <div class="page-header-right d-flex align-items-center gap-2">
            <a href="{{ route('manage-product.sub-category.create') }}" class="btn btn-sm btn-primary">
                <i class="bi bi-plus-circle me-2"></i>Create Sub Category
            </a>
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li class="dropdown-item-text">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" checked>
                            <label class="form-check-label">Parent Category</label>
                        </div>
                    </li>
                </ul>
            </div>
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <div class="table-responsive">
                <table class="table table-hover mb-0" id="subCategoryTable">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>Sub Category</th>
        ...
        <div class="card-footer py-2">
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-center gap-2">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <select id="subCategoryPageLength" class="form-select form-select-sm" style="width:auto">
                        <option value="5">5</option>
                        <option value="10">10</option>
                        <option value="25" selected>25</option>
                        <option value="50">50</option>
                    </select>
                    <span class="small text-muted" id="subCategoryTableInfo"></span>
                </div>
                <div id="subCategory_paginate" class="d-flex gap-1"></div>
            </div>
        </div>
...
<script>
    $(document).ready(function() {
        ...
        let table = $('#subCategoryTable').DataTable({
            processing: true
            , serverSide: true
            , ajax: "{{ route('manage-product.sub-category.datatable') }}"
            , dom: 'rt'
            , pageLength: 25
            ...
            , drawCallback: function() {
                ...
                $('#subCategoryTableInfo').html(
                    `Showing ${info.start + 1} to ${info.end} of ${info.recordsTotal}`
                );

                // Optional: custom pagination buttons
                updatePagination(this.api());
            }
        });

        $('#subCategoryPageLength').on('change', function() {
        ...
        function updatePagination(api) {
            ...
            $('#subCategory_paginate').html(html);
        }

        $('#subCategory_paginate').on('click', 'button', function() {
