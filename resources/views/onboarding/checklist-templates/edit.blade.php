...
<div class="page-header">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
        <div class="page-header-left d-flex" style="align-items: baseline;">
            <h1 class="page-title mb-0">Edit Checklist Template</h1>
...
<div class="main-body">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('onboarding.checklist-templates.update', $template->id) }}" method="POST">
                @csrf
                @method('PUT')
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="task_name" value="{{ old('task_name', $template->task_name) }}" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <textarea class="form-control" name="description" style="height: 100px;" rows="4">{{ old('description', $template->description) }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-md-7">
                                    <input type="text" class="form-control" name="task_category" value="{{ old('task_category', $template->task_category) }}" placeholder="e.g., HR, IT, Admin">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-md-7">
                                    <input type="number" class="form-control" name="sort_order" value="{{ old('sort_order', $template->sort_order) }}" min="0">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-md-7">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" name="is_mandatory" value="1" {{ old('is_mandatory', $template->is_mandatory) ? 'checked' : '' }}>
                                    </div>
                                </div>
                            </div>
                        </div>
