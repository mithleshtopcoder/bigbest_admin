@extends('layouts.app')
@section('title', 'Add Training Module')
@section('content')
<div class="page-header">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
        <div class="page-header-left d-flex" style="align-items: baseline;">
            <h1 class="page-title mb-0">Add Training Module</h1>
...
<div class="main-body">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('onboarding.training.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-10 mx-auto">
                        <div class="form-group row">
                            ...
                            <div class="col-md-4 ps-1">
                                <select class="form-control" name="module_type">
                                    <option value="video" {{ old('module_type') == 'video' ? 'selected' : '' }}>Video</option>
                                    <option value="document" {{ old('module_type') == 'document' ? 'selected' : '' }}>Document</option>
                                    <option value="quiz" {{ old('module_type') == 'quiz' ? 'selected' : '' }}>Quiz</option>
                                    <option value="assignment" {{ old('module_type') == 'assignment' ? 'selected' : '' }}>Assignment</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-4 ps-1">
                                <input type="number" class="form-control" name="duration_minutes" value="{{ old('duration_minutes') }}" min="0">
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4 ps-1">
                                <input type="url" class="form-control" name="video_url" value="{{ old('video_url') }}" placeholder="https://...">
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10 ps-1">
                                <textarea class="form-control" name="description" style="height: 120px;" rows="3">{{ old('description') }}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="form-label col-md-2" style="height: 140px;">Content</label>
                            <div class="col-md-10 ps-1">
                                <textarea class="form-control" name="content" style="height: 140px;" rows="5">{{ old('content') }}</textarea>
                            </div>
                        </div>
                    </div>
