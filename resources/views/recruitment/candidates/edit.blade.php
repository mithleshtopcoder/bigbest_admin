...
<div class="page-header">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
        <div class="page-header-left d-flex" style="align-items: baseline;">
            <h1 class="page-title mb-0">Edit Candidate</h1>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control" name="first_name" value="{{ old('first_name', $candidate->first_name) }}" required>
                            </div>
                            <label class="form-label col-md-2">Last Name <span class="text-danger">*</span></label>
                            <div class="col-md-4">
                                <input type="text" class="form-control" name="last_name" value="{{ old('last_name', $candidate->last_name) }}" required>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control" name="alternate_phone" value="{{ old('alternate_phone', $candidate->alternate_phone) }}">
                            </div>
                            <label class="form-label col-md-2">Date of Birth</label>
                            <div class="col-md-4">
                                <input type="date" class="form-control" name="date_of_birth" value="{{ old('date_of_birth', $candidate->date_of_birth) }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
                            ...
                            <div class="col-md-4">
                                <select class="form-select form-control" name="job_opening_id">
                                    ...
                                    @foreach($jobOpenings as $job)
                                        <option value="{{ $job->id }}" {{ old('job_opening_id', $candidate->job_opening_id) == $job->id ? 'selected' : '' }}>{{ $job->job_title }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <textarea class="form-control" style="height: 70px;" name="address" rows="3">{{ old('address', $candidate->address) }}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control" name="city" value="{{ old('city', $candidate->city) }}">
                            </div>
                            <label class="form-label col-md-2">State</label>
                            <div class="col-md-4">
                                <input type="text" class="form-control" name="state" value="{{ old('state', $candidate->state) }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control" name="pincode" value="{{ old('pincode', $candidate->pincode) }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                @if($candidate->resume_file)
                                    <div class="mb-2">
                                        <a href="{{ asset('storage/' . $candidate->resume_file) }}" target="_blank" class="btn btn-sm btn-outline-primary">View Current Resume</a>
                                    </div>
                                @endif
                    ...
                    <div class="col-md-12">
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <textarea class="form-control" style="height: 110px;" name="cover_letter" rows="4">{{ old('cover_letter', $candidate->cover_letter) }}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <textarea class="form-control" style="height: 70px;" name="notes" rows="3">{{ old('notes', $candidate->notes) }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
