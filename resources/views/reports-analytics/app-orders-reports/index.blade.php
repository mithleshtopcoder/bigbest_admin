...
@section('title', 'App Orders Reports')
...
<div class="page-header">
    <div class="page-header-left d-flex align-items-center">
        <div class="page-header-title">
            <h5 class="m-b-10">App Orders Reports</h5>
        </div>
        <ul class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Home</a></li>
            <li class="breadcrumb-item">Reports & Analytics</li>
            <li class="breadcrumb-item">App Orders Reports</li>
        </ul>
    </div>
...
<div class="main-body">
    <div class="row">
        <!-- [App Orders Reports] start -->
        <div class="col-12">
            <div class="card stretch stretch-full">
                <div class="card-header">
                    <h5 class="card-title">App Orders Reports</h5>
                        ...
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><span class="badge bg-gray-200 text-dark">21 orders</span></td>
                                    <td><span class="fw-bold text-dark">₹4,00,600</span></td>
                                    <td><span class="fw-bold text-info">₹8,500</span></td>
                                    <td><span class="fw-bold text-primary">₹3,92,100</span></td>
                                    <td class="text-end">
                                ...
                                <tr>
                                    ...
                                    <td><span class="fw-bold text-dark">₹3,00,400</span></td>
                                    <td><span class="fw-bold text-info">₹7,200</span></td>
                                    <td><span class="fw-bold text-primary">₹2,93,200</span></td>
                                    <td class="text-end">
                                        <div class="d-flex align-items-center gap-2 justify-content-end">
                                            <div class="dropdown">
                                                <a href="javascript:void(0);" class="avatar-text avatar-sm" data-bs-toggle="dropdown" data-bs-offset="25, 25" title="Actions">
                                ...
                                <tr>
                                    ...
                                    <td><span class="fw-bold text-dark">₹5,12,800</span></td>
                                    <td><span class="fw-bold text-info">₹10,000</span></td>
                                    <td><span class="fw-bold text-primary">₹5,02,800</span></td>
                                    <td class="text-end">
                                        <div class="d-flex align-items-center gap-2 justify-content-end">
                                            <div class="dropdown">
                                                <a href="javascript:void(0);" class="avatar-text avatar-sm" data-bs-toggle="dropdown" data-bs-offset="25, 25" title="Actions">
                                ...
                                <tr>
                                    ...
                                    <td><span class="fw-bold text-dark">₹4,24,500</span></td>
                                    <td><span class="fw-bold text-info">₹9,000</span></td>
                                    <td><span class="fw-bold text-primary">₹4,15,500</span></td>
                                    <td class="text-end">
                                        <div class="d-flex align-items-center gap-2 justify-content-end">
                                            <div class="dropdown">
                                                <a href="javascript:void(0);" class="avatar-text avatar-sm" data-bs-toggle="dropdown" data-bs-offset="25, 25" title="Actions">
                                ...
                                <tr>
                                    ...
                                    <td><span class="fw-bold text-dark">₹3,56,200</span></td>
                                    <td><span class="fw-bold text-info">₹7,500</span></td>
                                    <td><span class="fw-bold text-primary">₹3,48,700</span></td>
                                    <td class="text-end">
                                        <div class="d-flex align-items-center gap-2 justify-content-end">
                                            <div class="dropdown">
                                                <a href="javascript:void(0);" class="avatar-text avatar-sm" data-bs-toggle="dropdown" data-bs-offset="25, 25" title="Actions">
                                ...
                                <tr>
                                    ...
                                    <td><span class="fw-bold text-dark">₹4,67,300</span></td>
                                    <td><span class="fw-bold text-info">₹9,500</span></td>
                                    <td><span class="fw-bold text-primary">₹4,57,800</span></td>
                                    <td class="text-end">
                                        <div class="d-flex align-items-center gap-2 justify-content-end">
                                            <div class="dropdown">
                                                <a href="javascript:void(0);" class="avatar-text avatar-sm" data-bs-toggle="dropdown" data-bs-offset="25, 25" title="Actions">
                                ...
                                <tr>
                                    ...
                                    <td><span class="fw-bold text-dark">₹3,89,500</span></td>
                                    <td><span class="fw-bold text-info">₹8,000</span></td>
                                    <td><span class="fw-bold text-primary">₹3,81,500</span></td>
                                    <td class="text-end">
                                        <div class="d-flex align-items-center gap-2 justify-content-end">
                                            <div class="dropdown">
                                                <a href="javascript:void(0);" class="avatar-text avatar-sm" data-bs-toggle="dropdown" data-bs-offset="25, 25" title="Actions">
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge bg-gray-200 text-dark">17 orders</span></td>
                                    <td><span class="fw-bold text-dark">₹2,45,800</span></td>
                                    <td><span class="fw-bold text-info">₹6,500</span></td>
                                    <td><span class="fw-bold text-primary">₹2,39,300</span></td>
                                    <td class="text-end">
                                        <div class="d-flex align-items-center gap-2 justify-content-end">
                                            <div class="dropdown">
                                                <a href="javascript:void(0);" class="avatar-text avatar-sm" data-bs-toggle="dropdown" data-bs-offset="25, 25" title="Actions">
