...
<div class="max-w-7xl mx-auto pb-20">
    ...
    <div class="mb-6 flex justify-between items-center">
        <div>
            ...
            <p class="text-sm text-gray-500">Create role & assign permissions</p>
        </div>
    ...
    <form method="POST" action="{{ route('roles.store') }}">
        ...
        <div class="bg-white border rounded shadow p-6 mb-6">
            ...
            <input type="text" name="name" value="{{ old('name') }}" class="w-full rounded border-gray-300 focus:ring-indigo-500 focus:border-indigo-500" placeholder="e.g. Store Manager" required>
        </div>
                ...
                <div class="category-body hidden p-4">
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3">
                        ...
                        <label class="flex items-center gap-2 p-2 border rounded hover:bg-gray-50 permission-item">
                            <input type="checkbox" name="permissions[]" value="{{ $permission->id }}" class="permission-checkbox h-4 w-4 text-indigo-600">
